...
### 2. Attack (급등 추격) - v5.4 대폭 완화
- **진입**: L1(50점) / L2(70점) / L3(85점) - v5.4: 20점씩 하향
- **비중**: L1(10%) / L2(30%) / L3(50%)
- **Candle Surge**: 1분봉 +5% / 5분봉 +3% (RVOL 조건 필수)
- **Anti-Chase**: 일일 +30% 이상 차단 (급등 감지 시 우회)
- **예상 효과**: 하루 10-20건 진입 (기존 거의 0건)
- 트레일링 스탑 + 타임스톱 45분
...
### v5.4 (2026-02-05) - 급등 감지 완화 + Attack 대폭 완화 + DB 수정
- **Candle Surge 임계값 완화**: 조기 진입 기회 확대
  - 1분봉: 7% → 5% (RVOL 3x 유지)
  - 5분봉: 4% → 3% (RVOL 2x 유지)
- **Anti-Chase Gate 상향**: 20% → 30% (급등주 진입 허용 범위 확대)
- **Attack Score 대폭 완화**: 진입 기회 확대
  - L1: 70점 → 50점 (하루 10-20건 진입 예상, 기존 거의 0건)
  - L2: 82점 → 70점 (기존 L1 수준)
  - L3: 88점 → 85점 (약간 완화)
...
- **예상 효과**: 일일 신호 급증 (Candle Surge 8-12건 + Attack 10-20건)
- **위험**: 거짓 신호 증가 가능 (모니터링 필수)
