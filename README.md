...
### v5.4 (2026-02-05) - 급등 감지 완화 + Attack 완화 + DB 수정
- **Candle Surge 임계값 완화**: 조기 진입 기회 확대
  - 1분봉: 7% → 5% (RVOL 3x 유지)
  - 5분봉: 4% → 3% (RVOL 2x 유지)
- **Anti-Chase Gate 상향**: 20% → 30% (급등주 진입 허용 범위 확대)
- **Attack Score 완화**: 진입 기회 확대
  - L1: 70점 → 60점 (하루 5-10건 진입 예상, 기존 거의 0건)
  - L2: 82점 → 70점 (기존 L1 수준)
  - L3: 88점 → 85점 (약간 완화)
...
- **예상 효과**: 일일 신호 증가 (Candle Surge 8-12건 + Attack 5-10건)
