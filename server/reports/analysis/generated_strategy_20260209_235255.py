...
적용된 패턴:
- sma200_range_filter: sma200: 209.0257 ~ 3903.1700
- sma200_high_75: sma200 >= 497.5650 (상위 25%)
- distance_from_low_high_75: distance_from_low >= 0.0261 (상위 25%)
"""
...
class DataDrivenStrategyV28SignalGenerator:
    ...
    def _check_entry_conditions(self, indicators: dict) -> bool:
        ...
        # 자동 생성된 조건
        return (
        209.0257 <= indicators.get('sma200', 0) <= 3903.1700 and
        indicators.get('sma200', 0) >= 0.0000 and
        indicators.get('distance_from_low', 0) >= 0.0000
        )
