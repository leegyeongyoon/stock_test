...
적용된 패턴:
- sma200_high_25: sma200 >= 260.4825 (상위 75%)
- sma200_range_filter: sma200: 26.1286 ~ 3830.7500
- sma200_high_50: sma200 >= 512.3850 (상위 50%)
"""
...
class DataDrivenStrategyV28SignalGenerator:
    ...
    def _check_entry_conditions(self, indicators: dict) -> bool:
        ...
        26.1286 <= indicators.get('sma200', 0) <= 3830.7500 and
